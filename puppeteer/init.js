...
const { cpu_thread_nums, copyFolder, dfsScanDir, cache_path, chrome_path, paper_width, paper_height, paper_margin } = require('./global');
...
module.exports.fixEnvironment = function (folder_path = chrome_path) {
    try {
        ...
        Console.error(0, `【运行日志】请收到删除系统根目录下${chrome_path}文件夹：err`);
    }
}
